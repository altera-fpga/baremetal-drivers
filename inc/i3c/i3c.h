...
typedef enum {
    ...
    I3C_IOCTL_DEV_ADDR_TABLE_LOC1_GET,
    I3C_IOCTL_DEV_ADDR_TABLE_LOC1_SET,
    I3C_IOCTL_DEV_ADDR_TABLE_LOC5_GET,
    I3C_IOCTL_DEV_ADDR_TABLE_LOC5_SET,
